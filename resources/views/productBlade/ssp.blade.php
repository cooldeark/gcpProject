...
<div id="content">
          ...
          <!--hightChart end-->
            ...
            <div class="col-md-6">
                <img style="max-width: 600px;max-height: 500px;" src="{{asset('image/ssp01.png')}}"/>
              </div>
            ...
            <h2><b>檢視日報</b></h2>
            <div class="col-md-6">
                <img style="max-width:1280px;" src="{{asset('image/ssp02.png')}}"/>
              </div>
            ...
            <h2><b>網站管理</b></h2>
            <div class="col-md-6">
                <img style="max-width: 1280px;" src="{{asset('image/ssp03.png')}}"/>
              </div>
            ...
            <h2><b>報表查詢</b></h2>
            <div class="col-md-6">
                <img style="max-width: 1280px;" src="{{asset('image/ssp04.png')}}"/>
              </div>
